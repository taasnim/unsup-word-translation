...
def get_candidates(emb1, emb2, params):
    ...
    # contextual dissimilarity measure
        ...
        average_dist1 = torch.from_numpy(get_nn_avg_dist(emb2, emb1, knn)) #Compute the average distance of the `knn` nearest neighbors for a given set of embeddings and queries.
